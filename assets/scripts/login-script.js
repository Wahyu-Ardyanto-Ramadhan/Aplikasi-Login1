...
/**
* Membuat variabel lnputPasswordElement untuk tampilan input password.
* @constant {HTMLElemnt}
*/
...
loginFormElement.addEventListener('submit', function(event) {
  ...
  */
  ...
  if (email == expectedEmail && password == expectedPassword) {
    ...
    /* Comment : Jika sesui maka program akan berpindah ke halaman home. */
    goToHome();
  } else {

    /* Commnet : Namun jika tidak sesui maka akan menampilkan informasi bahwa input salah.  */
    showPopUp();
  }
});
